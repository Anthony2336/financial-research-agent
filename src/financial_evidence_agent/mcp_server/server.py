...
from financial_evidence_agent.mcp_server.tools import register_tools
from financial_evidence_agent.mcp_server.web_tools import register_web_tools
from financial_evidence_agent.retrieval.hybrid import BgeM3EmbeddingProvider, HybridRetriever
...
def create_server(
    ...
    *,
    ...
    mcp = FastMCP("financial-evidence-agent")
...
def main() -> None:
    ...
    from financial_evidence_agent.bootstrap import build_mcp_server
