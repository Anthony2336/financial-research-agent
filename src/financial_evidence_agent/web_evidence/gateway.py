...
from financial_evidence_agent.storage.cache import JsonCache, NoopJsonCache
...
def _web_cache_key(*, ticker: str, query: str, source_policy_version: str) -> str:
    query_hash = sha256(query.encode("utf-8")).hexdigest()
    return f"web:{ticker}:{query_hash}:{source_policy_version}"
